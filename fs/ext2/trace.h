...
DEFINE_EVENT(ext2_dio_class, name,					\
	TP_PROTO(struct kiocb *iocb, struct iov_iter *iter, int ret),	\
	TP_ARGS(iocb, iter, ret))
DEFINE_DIO_RW_EVENT(ext2_dio_write_iter_start);
DEFINE_DIO_RW_EVENT(ext2_dio_write_iter_dio_end);
DEFINE_DIO_RW_EVENT(ext2_dio_write_iter_buff_end);
DEFINE_DIO_RW_EVENT(ext2_dio_read_iter_start);
DEFINE_DIO_RW_EVENT(ext2_dio_read_iter_end);

TRACE_EVENT(ext2_dio_write_end_io,

...
/*
 * Btrfs uses page status Private2 to indicate there is an ordered extent for
 * the (sub)page range.
 *
 * Rename Set/Clear/Test/TestClearPagePrivate2 to
 * Set/Clear/Test/TestClearPageOrdered, to make it more readable.
 */
#define PageOrdered(page)		PagePrivate2(page)
#define SetPageOrdered(page)		SetPagePrivate2(page)
#define ClearPageOrdered(page)		ClearPagePrivate2(page)
#define TestPageOrdered(page)		TestPagePrivate2(page)
#define TestClearPageOrdered(page)	TestClearPagePrivate2(page)
#endif
